...
function addArrivalTracks(arrivals, previousArrivals = runtimeState.cachedData) {
    ...
    const recentTracks = [
        ...
        ...(previousArrivals?.aircraft || [])
            ...
            .map(aircraft => ({ icao24: aircraft.icao24.toLowerCase(), track: aircraft.track, expiresAt: timestamp + POST_LANDING_TRAIL_SECONDS }))
    ];
...
module.exports = { addArrivalTracks, classifyApproachDirection, distanceInKm, enrichGvaArrivals, fetchWithTimeout, getAircraftData, isAircraftRefreshPaused, isWithinSearchBounds, normalizeOpenSkyData, projectAircraftData, pruneEnrichmentCache, refreshAircraftDataOnce, startAircraftRefreshScheduler };
