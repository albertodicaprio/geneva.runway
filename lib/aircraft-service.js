...
function startAircraftRefreshScheduler() {
    ...
    const refresh = () => { void refreshAircraftDataOnce(); };
    refresh();
...
module.exports = { addArrivalTracks, classifyApproachDirection, distanceInKm, enrichGvaArrivals, fetchWithTimeout, getAircraftData, isWithinSearchBounds, normalizeOpenSkyData, projectAircraftData, pruneEnrichmentCache, refreshAircraftDataOnce, startAircraftRefreshScheduler };
