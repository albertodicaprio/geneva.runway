...
async function refreshAircraftData() {
    ...
    const data = addGeneralTraffic(addArrivalTracks(await enrichGvaArrivals(normalizedData)), normalizedData);
...
module.exports = { addGeneralTraffic, addArrivalTracks, classifyApproachDirection, distanceInKm, enrichGvaArrivals, fetchWithTimeout, getAircraftData, isAircraftRefreshPaused, isWithinSearchBounds, normalizeOpenSkyData, projectAircraftData, pruneEnrichmentCache, refreshAircraftDataOnce, startAircraftRefreshScheduler };
